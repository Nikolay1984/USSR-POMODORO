...
function _default(config) {
  ...
  function handlerTouchDown(e) {
    ...
    document.addEventListener("touchmove", handlerTouchmoveBind, {
      passive: false
    });
  ...
  ball.addEventListener("mousedown", handlerMouseDown); // mobile development

  ball.addEventListener("touchstart", handlerTouchDown); // Use function
  ...
  function handlerTouchmove(e) {
    ...
    const currentArc = calculateValuePosition(touchCordsPolar.angle, innerRadius); // console.log(currentArc)
